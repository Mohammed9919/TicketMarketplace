  ...
  return (
    <div className="w-full max-w-4xl mx-auto  ">
      <form  className="relative">
        ...
        <button
          type="submit"
          className="absolute right-3 top-1/2 -translate-y-1/2 bg-blue-600 text-white px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors duration-200 cursor-pointer"
        >
          Search
        </button>
      </form>
